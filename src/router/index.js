...
const routes = [
...

  {
    ...
    component: () =>
      import("../promoter/pages/promoter-dashboard.component.vue"),
  ...
  },
  {
    ...
    component: () =>
      import("../event-application/pages/event-applications.component.vue"),
    meta: { requiresAuth: true },
  },
  {
    ...
    component: () =>
      import(
        "../event-application/pages/event-application-detail.component.vue"
      ),
    meta: { requiresAuth: true },
  },
];
